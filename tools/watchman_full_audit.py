...
ROUTES = [
    ...
    "/api/watchman/device/push/ack?id=audit-none&deviceId=audit-device",
    "/api/watchman/device/push/pending?deviceId=audit-device",
    "/api/watchman/device/location?deviceId=audit-device&lat=33.8312&lon=-87.2775&accuracy=100",
    "/api/watchman/device/register?deviceId=audit-device",
    "/api/watchman/device/status",
    "/api/watchman/web-push/test?deviceId=audit-device",
    "/api/watchman/web-push/subscription?deviceId=audit-device",
    "/api/watchman/web-push/status",
    "/api/watchman/web-push/public-key",
